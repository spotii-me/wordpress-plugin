...
function renderContent() {
    ...
    return o.id = "spotii-popup__content", o.className = "spotii-popup__content", o.innerHTML = POPUP_CONTENT, o
}
    ...
    window.closeIFrameOnCompleteOrder = function ({
        ...
        if (console.log("Order state - ", e), first) {
            ...
            case "SUCCESS":
                ...
                break;
            case "FAILED":
                spottiCapture(t, "canceled", i, n, api), submit_error('<div class="woocommerce-error">Payment with Spotii failed. Please try again</div>')
            }
        }
